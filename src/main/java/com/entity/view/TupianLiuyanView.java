...
public class TupianLiuyanView extends TupianLiuyanEntity implements Serializable {
	...
	public TupianLiuyanView() {

	}

	public TupianLiuyanView(TupianLiuyanEntity tupianLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, tupianLiuyanEntity);
