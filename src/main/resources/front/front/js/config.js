...
var centerMenu = [
    ...
    ,{
        name: '图片收藏',
        url: '../tupianCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '图片',
        url: './pages/tupian/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/wenlishengcheng/admin/dist/index.html#/login";
